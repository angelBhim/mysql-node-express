...
router.get('/:type', function(req, res, next) {
    ...
    default :
        /*  hourly code block */
        myqry = "SELECT status_code, sum(h00) as h00, sum(h01) as h01, sum(h02) as h02, sum(h03) as h03, "
			...
			+ "where date(txn_date) = date(now()) group by status_code;";
	}
...
router.get('/:type/:id', function(req, res, next) {
	...
	var t = (m < 15)? String(t - 1)  : String(t);

	var id = "sum(h"+t.padStart(2,0)+") as h"+t.padStart(2,0);
	var options = req.query;
